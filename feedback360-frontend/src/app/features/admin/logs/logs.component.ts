...
@Component({ selector: 'app-logs', standalone: true, imports: [CommonModule, FormsModule, TranslateModule], templateUrl: './logs.component.html' })
export class LogsComponent implements OnInit {
  ...
  constructor(private admin: AdminService, private translate: TranslateService) {}
  ...
  syncNow(): void {
    this.admin.syncNow().subscribe(() => { this.syncMessage = this.translate.instant('adminLogs.syncTriggered'); setTimeout(()=>this.syncMessage=null,4000); this.currentPage=0; this.load(); });
  }
